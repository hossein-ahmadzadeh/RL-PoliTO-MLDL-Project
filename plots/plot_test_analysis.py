...
out_dir = "report/reinforce_nobaseline_nonnorm/images/test"
os.makedirs(out_dir, exist_ok=True)

# Load test data
returns = np.load("test_analysis/returns_test_model_reinforce_nobaseline_nonnorm.npy")
times = np.load("test_analysis/times_test_model_reinforce_nobaseline_nonnorm.npy")
