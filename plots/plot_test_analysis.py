...
out_dir = "report/model_reinforce_with_actor_critic_norm_tanh_action/images/test"
os.makedirs(out_dir, exist_ok=True)

# Load test data
returns = np.load("test_analysis/model_reinforce_with_actor_critic_norm_tanh_action/returns_test_model_reinforce_with_actor_critic_norm_tanh_action.npy")
times = np.load("test_analysis/model_reinforce_with_actor_critic_norm_tanh_action/times_test_model_reinforce_with_actor_critic_norm_tanh_action.npy")
