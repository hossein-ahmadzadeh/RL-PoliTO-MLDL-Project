...
model_names = [
    "model_actor_critic_simple",
    "model_actor_critic_simple_norm",
    "model_actor_critic_simple_tanh",
    "model_actor_critic_simple_norm_tanh"
]

# === Directories ===
log_base = "logs"
analysis_base = "analysis"
output_dir = "report/comparison3/images"    ## Change this to your desired output directory
